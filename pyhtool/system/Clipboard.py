...
EXCEPT_MSG = """
    pyhtool could not find a copy/paste mechanism for your system.
"""
...
def init_osx_pyhtool_clipboard():
    def copy_osx_pyhtool(text):
    ...
    def paste_osx_pyhtool():
        "Returns contents of clipboard"
        board = AppKit.NSPasteboard.generalPasteboard()
        content = board.stringForType_(AppKit.NSStringPboardType)
        return content

    return copy_osx_pyhtool, paste_osx_pyhtool
...
def determine_clipboard():
    ...
    if os.name == 'mac' or platform.system() == 'Darwin':
        try:
            import Foundation  # check if pyhtool is installed
            import AppKit
        except ImportError:
            return init_osx_pbcopy_clipboard()
        else:
            return init_osx_pyhtool_clipboard()
...
def set_clipboard(clipboard):
    ...
    clipboard_types = {
        ...
        "pyhtool": init_osx_pyhtool_clipboard,
