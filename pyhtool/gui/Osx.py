...
try:
    ...
    assert False, "You must first install pyobjc-core and pyobjc: https://pyhtool.readthedocs.io/en/latest/install.html"
import AppKit

if sys.platform !=  'darwin':
    raise Exception('The pyhtool_osx module should only be loaded on an OS X system.')
